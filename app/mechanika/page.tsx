...
export default function MechanikaPage() {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (snap) => {
      ...
      console.error("Błąd ładowania warsztatów:", error);
      setLoading(false);
    });
  ...
  return (
    <> 
      ...
      <section className="relative bg-[#0f172a] text-white pt-40 pb-40 px-6 overflow-hidden">
        ...
        {/* TŁO ZDJĘCIOWE Z OVERLAYEM (ZDJĘCIE WARSZTATU) */}
        <div className="absolute inset-0 z-0 pointer-events-none">
          <img 
            src="/img/Mechanika-pojazdowa-Mistrzowieregionu.webp" 
            alt="Profesjonalny warsztat samochodowy i mechanika pojazdowa" 
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 font-montserrat">
          ...
          <p className="text-slate-300 text-lg md:text-xl mb-12 max-w-2xl mx-auto leading-relaxed font-medium drop-shadow-lg">
            Oddaj auto w ręce ekspertów, którym zależy na bezpieczeństwie. 
            Sprawdzone warsztaty, precyzyjna diagnostyka i transparentne ceny bez naciągania. <span className="text-white font-bold">Zaufaj rzemiosłu.</span>
          </p>
      ...
      <div className="bg-[#f8fafc] text-[#1e293b] rounded-t-[3rem] -mt-20 relative z-20 shadow-[0_-15px_50px_rgba(0,0,0,0.3)] pb-24">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-500 max-w-2xl mx-auto italic font-medium">
                "Uśrednione ceny rynkowe za robociznę w regionie. Dokładny koszt jest ustalany przez warsztat po oględzinach."
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-[2rem] shadow-lg p-8 border-t-4 border-[#d4af37] border-x border-b border-slate-100 text-center transform hover:-translate-y-2 transition-transform duration-300">
                <h3 className="text-xl font-black text-[#0f172a] mb-2 uppercase">Wymiana Oleju</h3>
                <p className="text-[10px] font-black text-slate-400 mb-6 uppercase tracking-[0.2em]">Z kompletem filtrów</p>
              ...
              <div className="bg-[#0f172a] rounded-[2rem] shadow-2xl p-8 border-t-4 border-[#d4af37] text-center transform md:scale-105 relative">
                ...
                <h3 className="text-xl font-black text-white mb-2 mt-4 uppercase">Diagnostyka Komputerowa</h3>
                <p className="text-[10px] font-black text-slate-400 mb-6 uppercase tracking-[0.2em]">Odczyt i kasowanie błędów</p>
                <p className="text-4xl font-black text-[#d4af37]">od 100 <span className="text-lg text-slate-300 font-normal">PLN</span></p>
              </div>

              <div className="bg-white rounded-[2rem] shadow-lg p-8 border-t-4 border-[#d4af37] border-x border-b border-slate-100 text-center transform hover:-translate-y-2 transition-transform duration-300">
                <h3 className="text-xl font-black text-[#0f172a] mb-2 uppercase">Serwis Klimatyzacji</h3>
                <p className="text-[10px] font-black text-slate-400 mb-6 uppercase tracking-[0.2em]">Odgrzybianie + czynnik</p>
                <p className="text-4xl font-black text-[#d4af37]">od 150 <span className="text-lg text-slate-400 font-normal">PLN</span></p>
              </div>
            </div>
          </div>
        </section>

        {/* RANKING FIRM MECHANICZNYCH */}
            ...
            <div className="grid grid-cols-1 gap-12 text-left">
              {loading ? (
                <div className="text-center py-20 font-black uppercase tracking-widest animate-pulse text-slate-400 italic">
                  Rozgrzewamy silniki bazy danych...
                </div>
              ) : (
                <>
                  ...
                  {/* Puste miejsce, jeśli firm jest mało */}
                  {companies.length < 3 && (
                    <div className="bg-slate-50/50 border-2 border-dashed border-slate-200 rounded-[3rem] p-10 flex flex-col justify-center items-center text-center min-h-[300px] hover:border-[#d4af37]/50 hover:bg-white transition-all group mt-8">
                      ...
                      <h3 className="text-xl font-black text-[#0f172a] mb-3 uppercase tracking-widest italic">
                        MIEJSCE DLA TWOJEGO WARSZTATU
                      </h3>
                      <p className="text-slate-500 text-sm font-medium mb-8 max-w-md">
                        Twój serwis robi solidną robotę? Zdobądź zaufanie klientów w Gminie Nieporęt i dołącz do liderów.
                      </p>
        ...
        {/* MODUŁ SEO: PORADY DLA KIEROWCÓW */}
        <section className="py-24 bg-slate-50 border-t border-slate-200">
          <div className="max-w-4xl mx-auto px-6 font-montserrat">
            <div className="text-center mb-16">
              <span className="text-[#d4af37] font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Z Poradnika Mechanika</span>
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a] mb-6 tracking-tighter uppercase leading-tight">
                2 Mity, przez które zniszczysz silnik
              </h2>
            ...
            <div className="space-y-8 italic text-slate-600 font-medium leading-relaxed">
              <div className="bg-white p-8 rounded-[2.5rem] shadow-md border-l-8 border-l-[#d4af37]">
                <h3 className="text-xl font-black text-[#0f172a] mb-3 uppercase tracking-tight not-italic">1. Olej "Long Life" - czyli życie do pierwszej awarii</h3>
                <p>
                  Producenci aut sugerują wymianę oleju co 30 000 km, żeby obniżyć pozorne koszty serwisu w katalogu reklamowym. Prawda jest brutalna: w miejskiej jeździe olej traci swoje właściwości już po 10 000 - 15 000 km. Wymieniaj go częściej, a silnik odwdzięczy się długowiecznością.
                </p>
              </div>
              <div className="bg-white p-8 rounded-[2.5rem] shadow-md border-l-8 border-l-[#0f172a]">
                <h3 className="text-xl font-black text-[#0f172a] mb-3 uppercase tracking-tight not-italic">2. Kontrolka "Check Engine" sama zgaśnie</h3>
                <p>
                  Zignorowanie żółtej kontrolki to jak ignorowanie gorączki. Auto może "jechać normalnie", ponieważ weszło w tryb awaryjny, podając bogatszą mieszankę paliwa. Na dłuższą metę wypala to katalizator, zapycha filtr DPF i dewastuje budżet. Diagnostyka za 100 zł ratuje tysiące złotych na naprawach.
                </p>
              </div>
            </div>
          </div>
