...
// 1. POPRAWIONY IMPORT WIZYTÓWKI (Nasz "Złoty Standard")
    ...
    const unsub = onSnapshot(q, (snap) => {
      const fetched = snap.docs.map(doc => {
        ...
        return {
          id: doc.id,
          ...data,
          // 2. BEZPIECZNE USTAWIENIE PAKIETU
      ...
      console.error("Błąd ładowania firm sprzątających:", error);
      setLoading(false);
    });
  ...
  return (
    <> 
      ...
      <section className="relative bg-[#0f172a] text-white pt-40 pb-40 px-6 overflow-hidden">
        ...
        {/* TŁO ZDJĘCIOWE Z OVERLAYEM (ZDJĘCIE SPRZĄTANIA) */}
        <div className="absolute inset-0 z-0 pointer-events-none">
          <img 
            src="/img/Sprzatanie-mistrzowieregionu.webp" 
            alt="Profesjonalne sprzątanie wnętrz" 
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 font-montserrat">
          ...
          <p className="text-slate-300 text-lg md:text-xl mb-12 max-w-2xl mx-auto leading-relaxed font-medium drop-shadow-lg">
            Odzyskaj swój wolny czas. Wybraliśmy najbardziej zaufane i rzetelne firmy sprzątające w regionie, które zadbają o blask Twojego domu. <span className="text-white font-bold">Bezpiecznie i dyskretnie.</span>
          </p>
      ...
      <div className="bg-[#f8fafc] text-[#1e293b] rounded-t-[3rem] -mt-20 relative z-20 shadow-[0_-15px_50px_rgba(0,0,0,0.3)] pb-24">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a] tracking-tighter mb-4 uppercase">
                ŚREDNIE STAWKI - SPRZĄTANIE 2026
              </h2>
              ...
              <p className="text-slate-500 max-w-2xl mx-auto italic font-medium">
                "Uśrednione ceny rynkowe za usługi w Gminie Nieporęt. Końcowy koszt zależy od metrażu i stopnia zabrudzenia."
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-[2rem] shadow-lg p-8 border-t-4 border-[#d4af37] border-x border-b border-slate-100 text-center transform hover:-translate-y-2 transition-transform duration-300">
                <h3 className="text-xl font-black text-[#0f172a] mb-2 uppercase">Sprzątanie Domów</h3>
                <p className="text-[10px] font-black text-slate-400 mb-6 uppercase tracking-[0.2em]">Cykliczne (raz w tygodniu)</p>
              ...
              <div className="bg-[#0f172a] rounded-[2rem] shadow-2xl p-8 border-t-4 border-[#d4af37] text-center transform md:scale-105 relative">
                ...
                <h3 className="text-xl font-black text-white mb-2 mt-4 uppercase">Sprzątanie Po Remoncie</h3>
                <p className="text-[10px] font-black text-slate-400 mb-6 uppercase tracking-[0.2em]">Odkurzanie pyłu budowlanego</p>
                <p className="text-4xl font-black text-[#d4af37]">indywid. <span className="text-lg text-slate-300 font-normal">wycena</span></p>
              </div>

              <div className="bg-white rounded-[2rem] shadow-lg p-8 border-t-4 border-[#d4af37] border-x border-b border-slate-100 text-center transform hover:-translate-y-2 transition-transform duration-300">
                <h3 className="text-xl font-black text-[#0f172a] mb-2 uppercase">Pranie Tapicerki</h3>
                <p className="text-[10px] font-black text-slate-400 mb-6 uppercase tracking-[0.2em]">Narożniki, dywany, fotele</p>
                <p className="text-4xl font-black text-[#d4af37]">od 120 <span className="text-lg text-slate-400 font-normal">PLN</span></p>
              </div>
            </div>
          </div>
        </section>

        {/* RANKING FIRM SPRZĄTAJĄCYCH */}
        <section id="ranking" className="py-24 bg-white font-montserrat border-t border-slate-200">
          <div className="max-w-7xl mx-auto px-6 text-center">
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-6 tracking-tighter uppercase">
              REKOMENDOWANE EKIPY SPRZĄTAJĄCE
            </h2>
            ...
            <div className="grid grid-cols-1 gap-12 text-left">
              {loading ? (
                <div className="text-center py-20 font-black uppercase tracking-widest animate-pulse text-slate-400 italic">
                  Polerujemy ranking najlepszych...
                </div>
              ) : (
                <>
                  ...
                  {/* Puste miejsce jeśli brakuje firm */}
                  {companies.length < 3 && (
                    <div className="bg-slate-50/50 border-2 border-dashed border-slate-200 rounded-[3rem] p-10 flex flex-col justify-center items-center text-center min-h-[300px] hover:border-[#d4af37]/50 hover:bg-white transition-all group mt-8">
                      ...
                      <p className="text-slate-500 text-sm font-medium mb-8 max-w-md">
                        Prowadzisz rzetelną firmę sprzątającą? Dołącz do liderów i zdobywaj zaufanych klientów z Gminy Nieporęt.
                      </p>
        ...
        {/* MODUŁ SEO: PORADNIK CZYSTOŚCI */}
        <section className="py-24 bg-slate-50 border-t border-slate-200">
          <div className="max-w-4xl mx-auto px-6 font-montserrat">
            <div className="text-center mb-16">
              <span className="text-[#d4af37] font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Z Poradnika Czystości</span>
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a] mb-6 tracking-tighter uppercase leading-tight">
                Dlaczego warto wybrać profesjonalną firmę sprzątającą?
              </h2>
            ...
            <div className="space-y-8 italic text-slate-600 font-medium leading-relaxed">
              <div className="bg-white p-8 rounded-[2.5rem] shadow-md border-l-8 border-l-[#d4af37]">
                <h3 className="text-xl font-black text-[#0f172a] mb-3 uppercase tracking-tight not-italic">1. Profesjonalna Chemia i Sprzęt</h3>
                <p>
                  Domowe środki czystości z marketu często tylko maskują brud lub ładnie pachną. Profesjonalne ekipy dysponują specjalistyczną chemią oraz sprzętem (np. odkurzacze piorące, myjki parowe), które usuwają najcięższe zabrudzenia, roztocza i alergeny, nie niszcząc przy tym Twoich powierzchni.
                </p>
              </div>
              <div className="bg-white p-8 rounded-[2.5rem] shadow-md border-l-8 border-l-[#0f172a]">
                <h3 className="text-xl font-black text-[#0f172a] mb-3 uppercase tracking-tight not-italic">2. Twój Bezcenny Czas</h3>
                <p>
                  Generalne sprzątanie domu może zająć cały weekend. Zlecając to profesjonalistom, "kupujesz" swój własny czas, który możesz przeznaczyć na relaks, rodzinę lub rozwój osobisty. Rzetelna ekipa uwinie się z pracą szybciej, zostawiając dom w stanie perfekcyjnym.
                </p>
              </div>
            </div>
          </div>
